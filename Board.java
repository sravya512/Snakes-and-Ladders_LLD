...
public class Board {
	...
	public boolean movePlayer(Player player, int value){
		...
		if (position == 100){
            ...
            int a=position-100;
            System.out.println("Oops ! you should get the value less than or equal to "+a+" when you rolled dice");
            return false;
        }
         else {
			...
			playerPositions.put(player, position);
            int afterPosition=position;
            System.out.println(player + " moves from "+beforePosition+" to "+afterPosition);
			return false;
		}
